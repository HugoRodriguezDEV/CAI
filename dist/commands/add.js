...
export async function addCommand(tool, type, name, cwd) {
...
async function findFolderRecursively(dir, targetName) {
    try {
...
async function copyDirRecursively(src, dest) {
...
async function getResources(baseDir, relativePath) {
...
async function registerSkillInConfig(cwd, tool, skillName, description) {
